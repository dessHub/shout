  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" role="form" method="POST" action="{{ url('/close') }}">
            {{ csrf_field() }}
            ...
            <div class="form-group">
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="hidden" name="status" id="status" value="closed"/>
            ...
            <div class="form-group">
                <label for="complaint" class="col-md-4 control-label">Conclude the case</label>
